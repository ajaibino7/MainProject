...
def summarizer(script):
    ...
    input_ids = tokenizer_t("summarize: " + script, return_tensors="pt",min_length=1500, max_length=2048, truncation=True).input_ids
    ...
    if request.method == 'POST':
        ...
        if request.form['submit_button'] == 'transcript':
            try:
                ...
                transcript = transcript.replace("<pad>","")
            
                transcript = transcript.split("...")[0]
            except Exception as e:
                print(e)
            return render_template('summery.html', summary=transcript)
           
        elif request.form['submit_button'] == 'summery':
